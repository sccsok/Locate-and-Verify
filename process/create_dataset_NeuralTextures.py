...
parser.add_argument('--scale', type=float, default =1.55, help='enables resizing')
...
def to_bw(mask, thresh_binary=15, thresh_otsu=255):
    ...
    (thresh, im_bw) = cv2.threshold(im_gray, thresh_binary, thresh_otsu, cv2.THRESH_BINARY)
...
def extract_face_videos(output_path):
    ...
    f_img_altered = os.path.join(output_path, 'NeuralTextures')
