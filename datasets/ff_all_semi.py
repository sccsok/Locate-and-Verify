...
class FaceForensics(Dataset):
    def __init__(self,
        ...
        # define FaceLandmark to get reference regions for semi-supervised strategy
        self.fcm = FaceLandmark(ref=opt['datasets']['semi']['ref'])
    ...
    def __getitem__(self, index):
        ...
        region = self.fcm.get_mask(image)
        ...
        region = self.transforms['mask'](image=region)['image']

        return image, label, mask, region
